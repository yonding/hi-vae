...
def parse_args():
    ...
    parser.add_argument(
        "--epochs", default=1000, type=int, help="Set the number of epochs."
    )
    ...
    parser.add_argument("--H", default=50, help="Set the first hidden dimension.")
    parser.add_argument("--H2", default=12, help="Set the second hidden dimension.")
    parser.add_argument("--latent_dim", default=3, help="Set the latent dimension.")
    parser.add_argument("--batch_size", default=1024, help="Set the latente dimension.")
